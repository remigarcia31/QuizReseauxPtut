    ...
    <div class="container"> <!-- Container avec les informations concernant les protections des données -->
        <div class="texte">
            ...
            <p>Nous avons nommé un Correspondant informatique et Liberté chargé de garantir la
                ...
                <br/>
                En savoir plus : <a href="https://www.cnil.fr/fr/correspondants-informatique-et-libertes-cil"
                                    target="_blank">
            ...
            <h3>- D'un droit d'accès :</h3> Le droit pour toute personne d'obtenir la communication de toutes les
            informations la concernant.<br/>
            <h3>- D'un droit de rectification :</h3> Le droit pour toute personne d'obtenir la rectification des
            informations inexactes la concernant.<br/>
            ...
            Vous pouvez faire une demande d'accès à vos données ou exercer vos droits en écrivant aux adresses mail
            suivantes :<br/>
            ...
            Vous pouvez exercer vos droits d'opposition au transfer de vos données en écrivant aux adresses mail
            suivantes :<br/>
            thomas.gaffet@iut-rodez.fr<br/>
            loic.rieudebat@iut-rodez.fr<br/>
            remi.garcia@iut-rodez.fr<br/>
            ...
            Vous pouvez exercer votre droit à donner des directives concernant vos données après votre décès en écrivant
            aux adresses mail suivantes :<br/>
            thomas.gaffet@iut-rodez.fr<br/>
            loic.rieudebat@iut-rodez.fr<br/>
            remi.garcia@iut-rodez.fr<br/>
            adam.khalepo@iut-rodez.fr
            ...
            <br/>
            - Les cookies essentiels : Ces cookies sont nécessaires au bon fonctionnement de notre site et vous
            permettent d’utiliser les fonctionnalités de base.
            Sans ces cookies, vous ne pourrez pas utiliser notre site de manière fonctionnelle.<br/><br/>
            - Les cookies de confort : Ces cookies amènent des fonctionnalités supplémentaires qui sont susceptibles
            d’intéresser l’internaute,
            sans pour autant être indispensables au fonctionnement de base du site. <br/><br/>
            - Les cookies analytiques : Ces cookies nous permettent de connaître l’utilisation et les performances de
            notre site et d’en améliorer le fonctionnement.
            Ils portent par exemple sur les pages les plus consultées, les requêtes faites dans notre moteur de
            recherche etc.<br/><br/>
            - Les cookies publicitaires : Ces cookies collectent des informations sur vos habitudes de navigation dans
            le but de vous présenter des publicités adaptées à vos centres d’intérêt.
            Ces cookies enregistrent votre visite sur notre site, les pages que vous avez visitées et les liens que vous
            avez suivis ainsi que votre navigation en dehors de notre site.
            ...
            Vous pouvez restreindre, bloquer ou supprimer les Cookies de ce site Internet à tout moment en modifiant la
            configuration de votre navigateur.
            Puisque les paramètres sont différents d’un navigateur à l’autre, la configuration des Cookies s’effectue
            habituellement dans les menus « Préférences » ou « Outils ».
            Pour de plus amples informations sur la configuration des Cookies dans votre navigateur, veuillez consulter
            le menu « Aide » de ce dernier.
            <br/><br/>
            <h3>Le paramétrage est spécifique à chaque navigateur</h3>
            Pour Internet Explorer™ : <a target="_blank"
                                         href="https://support.microsoft.com/fr-fr/help/17442/windows-internet-explorer-delete-manage-cookies">https://support.microsoft.com/fr-fr/help/17442/windows-internet-explorer-delete-manage-cookies</a><br/>
            Pour Firefox™ : <a target="_blank"
                               href="https://support.mozilla.org/fr/kb/activer-desactiver-cookies-preferences">https://support.mozilla.org/fr/kb/activer-desactiver-cookies-preferences</a><br/>
