...
<body>
    ...
    <div class="container-fluid">
        ...
        <h2>Correction</h2>
        <br />
        <!-- affichage du formulaire pour le quizz ethernet -->
        <table class="container" border="2">
            ...
            $note = 0;
            //on affiche la correction du scénario sur lequel l'utilisateur à travaillé
        ...
        <table class="container" border="2">
            ...
            <tr>
                ...
                <?php
                //On compare chaque réponse que l'utilisateur à saisie avec la correction
                /* 
                Si la réponse de l'utilisateur est la meme que la correction, 
                alors on affiche son message en vert et on ajoute un point à la note.
                Sinon on affiche sa réponse en rouge pour plus de clarté  
                */
        ...
        <?php
        //Affichage de la note de l'utilisateur (note sur 10)
        echo "<h2> Vous avez eu $note/10 </h2>";
        ?>
        <br />
        <!-- bouton pour retourner au choix du quizz ethernet-->
        <form action="index.php" method="post">
            <input hidden name="action" value="ethernet">
            <input hidden name="controller" value="Ethernet">
