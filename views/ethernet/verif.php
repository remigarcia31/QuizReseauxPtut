        ...
        <form action="index.php" method="POST">
            <table class="container enonceScenario">
                <tr>
                    ...
                    <td><input name="pseudo" type="text" placeholder="Veuillez rentrer l'identifiant administrateur"
                               size="40" required></td>
                </tr>
                <tr>
                    <th>Mot de passe :</th>
                    <td><input name="pwd" type="password" placeholder="Veuillez rentrer le mot de passe" size="40"
                               required></td>
                </tr>
            </table>
